export const regalConfig = {
  ...
  selectors: {
    ...
    oktaVerifyTotpSelect: "[data-se='okta_verify-totp'] a[data-se='button'], a[aria-label*='Okta Verify app' i], a[aria-label*='enter a code' i]",
    googleAuthenticatorCode: "input[name='credentials.passcode'][type='text'], input[name='credentials.totp'][type='text']",
    googleAuthenticatorSubmit: "input[type='submit'][value='Verify']",
    siteSelect: "select[id$='_header_ddlSite'], select[name$='$header$ddlSite'], select[id*='ddlSite'], select[name*='ddlSite']",
    ...
    lineDetailSubmit: "input[type='submit'][name='LineDetail'][value='Show Line Detail' i], input[name='LineDetail'][value='Show Line Detail' i], input[type='submit'][name='LineDetail'][value='Hide Line Detail' i], input[name='LineDetail'][value='Hide Line Detail' i]",
    lineDetailShowSubmit: "input[type='submit'][name='LineDetail'][value='Show Line Detail' i], input[name='LineDetail'][value='Show Line Detail' i]",
    lineDetailHideSubmit: "input[type='submit'][name='LineDetail'][value='Hide Line Detail' i], input[name='LineDetail'][value='Hide Line Detail' i]",
    lineDetailTable: "table:has(td.tdclaim:has-text('SEQNM'))",
    lineDetailAdjustmentTable: "table:has(td.tdclaim:has-text('Deductible')):has(td.tdclaim:has-text('Adjustment Reason'))",
  },
  runtime: {
    supportsLocal: true,
