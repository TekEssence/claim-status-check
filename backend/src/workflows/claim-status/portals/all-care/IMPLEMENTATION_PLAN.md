# AllCare Claim Status

AllCare is an independent claim-status portal. Login rows use `Group`, `Payer`,
...
extend only those AllCare selectors when exact production markup is available.
