...
async function searchTriwestVaCcnServiceDatesWithProvider(page, providerName, rowData, options = {}) {
  ...
  const charmContext = "Charm TRIWEST-VA CCN Service Dates";
...
module.exports = createServiceDateWorkflow({
  ...
  searchWithProvider: searchTriwestVaCcnServiceDatesWithProvider,
  readResultRows: getTriwestVaCcnServiceDateRows,
  selectMatchedRows: selectTriwestVaCcnMatchedRows,
  extractMatchedRow: extractTriwestVaCcnMatchedRow,
});
