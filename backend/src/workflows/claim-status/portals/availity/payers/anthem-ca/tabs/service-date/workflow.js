...
module.exports = createServiceDateWorkflow({
  ...
  searchWithProvider: searchAnthemCaServiceDatesWithProvider,
  readResultRows: getAnthemCaServiceDateRows,
  selectMatchedRows: selectAnthemCaMatchedRows,
  extractMatchedRow: extractAnthemCaMatchedRow,
});
