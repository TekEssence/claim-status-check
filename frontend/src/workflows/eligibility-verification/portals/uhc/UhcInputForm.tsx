  ...
  return (
    <form onSubmit={props.onSubmit} className="space-y-5">
      <div className="grid gap-4 lg:grid-cols-2">
        <PortalUploadCard mode="file" accept=".xlsx,.xls" acceptedFormats=".xlsx, .xls" description="Upload Project, Portal, Link, Username, Password, and Secret Key. The selected project's UHC row is used automatically." fileName={props.credentialFile?.name} icon={KeyRound} inputId="uhcEligibilityCredentials" onFileSelect={props.onCredentialFileChange} sizeHint="25 MB" title="Upload UHC Login File" />
