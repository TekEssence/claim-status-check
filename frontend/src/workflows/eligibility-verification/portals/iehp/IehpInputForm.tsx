  ...
  return (
    <form onSubmit={props.onSubmit} className="space-y-5">
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        ...
        <PortalUploadCard mode="file" accept=".xlsx,.xls" acceptedFormats=".xlsx, .xls" description="Upload the MedRevenu eligibility workbook containing Primary Insurance Name, Primary Insurance ID#, Patient Name, DOB, and DOS." fileName={props.inputFile?.name} icon={FileSpreadsheet} inputId="iehpEligibilityInput" onFileSelect={props.onInputFileChange} sizeHint="25 MB" title="Upload Eligibility File" />
      </div>
