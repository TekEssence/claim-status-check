...
export function AllCareInputForm({ canSubmit, credentialFileName, inputFileName, isProcessing, onCredentialFileChange, onInputFileChange, onSubmit }: {
  canSubmit: boolean;
  ...
  return (
    <form className="space-y-5" onSubmit={onSubmit}>
      ...
      <p className="text-center text-sm text-slate-500">The completed AllCare output downloads automatically.</p>
    </form>
  );
}
