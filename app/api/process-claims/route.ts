...
export async function POST(req: Request) {
  ...
  // Job ID is generated by the client and sent in formData.
  // This lets the browser open the Edge relay BEFORE the POST response
  // arrives, which is critical because Vercel's edge proxy buffers the
  // entire POST response (headers + body) before delivering it.
